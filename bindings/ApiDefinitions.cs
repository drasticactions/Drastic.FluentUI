...
namespace Drastic.FluentUI
{
	...
	[Protocol (Name = "_TtP8FluentUI22AccessibleViewDelegate_"), Model (AutoGeneratedName = true)]
	...
	[Protocol (Name = "_TtP8FluentUI27AccessibleTableViewDelegate_"), Model (AutoGeneratedName = true)]
...
*/[Protocol]
	...
	interface MSFBadgeFieldDelegate
	{
		...
		void BadgeField (MSFBadgeField badgeField, string newText);
		...
		void BadgeField (MSFBadgeField badgeField, MSFBadgeView badge);
		...
		bool BadgeField (MSFBadgeField badgeField, MSFBadgeViewDataSource badgeDataSource);
		...
		MSFBadgeView BadgeField (MSFBadgeField badgeField, MSFBadgeViewDataSource badgeDataSource);
		...
		MSFBadgeView BadgeField (MSFBadgeField badgeField, MSFBadgeViewDataSource[] badgeDataSources);
		...
		bool BadgeField (MSFBadgeField badgeField, MSFBadgeView badge);
	...
	interface MSFBottomCommandingControllerDelegate
	{
		...
		void BottomCommandingController (MSFBottomCommandingController bottomCommandingController, BottomCommandingInteraction commandingInteraction);
...
*/[Protocol]
	...
	interface MSFCommandBar
	{
		...
		NativeHandle Constructor (NSArray<MSFCommandBarItem>[] itemGroups, [NullAllowed] MSFCommandBarItem leadingItem, [NullAllowed] MSFCommandBarItem trailingItem);
		...
		[DesignatedInitializer]
		NativeHandle Constructor (NSArray<MSFCommandBarItem>[] itemGroups, [NullAllowed] NSArray<MSFCommandBarItem>[] leadingItemGroups, [NullAllowed] NSArray<MSFCommandBarItem>[] trailingItemGroups);
	...
	interface MSFDateTimePickerDelegate
	{
		...
		void DateTimePicker (MSFDateTimePicker dateTimePicker, NSDate startDate, NSDate endDate);
		...
		bool DateTimePicker (MSFDateTimePicker dateTimePicker, NSDate startDate, NSDate endDate);
	}
...
*/[Protocol (Name = "_TtP8FluentUI25MSFActivityIndicatorState_")]
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI25MSFAvatarGroupAvatarState_")]
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI19MSFAvatarGroupState_")]
	interface MSFAvatarGroupState
	{
		...
		[Export ("createAvatar")]
		[Verify (MethodToProperty)]
		MSFAvatarGroupAvatarState CreateAvatar { get; }
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI14MSFAvatarState_")]
	...
	[BaseType (typeof(ControlHostingView), Name = "_TtC8FluentUI12MSFCardNudge")]
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI17MSFCardNudgeState_")]
	[BaseType (typeof(NSObject), Name = "_TtP8FluentUI17MSFCardNudgeState_")]
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI15MSFDividerState_")]
  ...
  protocol, then [Model] is redundant and will generate code that will never
  be used.
*/[Protocol (Name = "_TtP8FluentUI32MSFIndeterminateProgressBarState_")]
...
*/[Protocol (Name = "_TtP8FluentUI29MSFPersonaCarouselButtonState_")]
	...
	[Protocol, Model (AutoGeneratedName = true)]
	interface MSFPeoplePickerDelegate : IMSFBadgeFieldDelegate
	{
		...
		void PeoplePicker (MSFPeoplePicker peoplePicker, string text, Action<NSArray<MSFPersona>> completion);
		...
		bool PeoplePicker (MSFPeoplePicker peoplePicker, MSFPersona persona);
		...
		MSFPersona PeoplePicker (MSFPeoplePicker peoplePicker, string text);
		...
		void PeoplePicker (MSFPeoplePicker peoplePicker, Action<NSArray<MSFPersona>, bool> completion);
...
*/[Protocol]
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface MSFPopupMenuItem : IMSFPopupMenuTemplateItem
	{
...
*/[Protocol]
	...
	interface MSFShimmerView
	{
		...
		MSFAnimationSynchronizerProtocol AnimationSynchronizer { get; set; }
		...
		[DesignatedInitializer]
		NativeHandle Constructor ([NullAllowed] UIView containerView, UIView[] excludedViews, [NullAllowed] MSFAnimationSynchronizerProtocol animationSynchronizer, MSFShimmerStyle shimmerStyle, bool shimmersLeafViews, bool usesTextHeightForLabels);
	...
	interface MSFTableViewHeaderFooterView
	{
		...
		void SetupWithStyle (MSFTableViewHeaderFooterViewStyle style, string accessoryButtonTitle);
		...
		void SetupWithStyle (MSFTableViewHeaderFooterViewStyle style, string title);
